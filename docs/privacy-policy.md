...
Your audiobook files, playback positions, bookmarks, covers, and preferences are stored **only on your device** (and in your device backups if you have enabled Android system backup). We never transmit them anywhere.
...
- **Internet / Network state** — optional online cover search only (see above).
- **Foreground service / media playback** — to keep playing audio and show media controls while the app is in the background.
...
If this policy changes, we will update this page and the "Last updated" date above. Because the app collects no data, any changes will be minor and informational.
