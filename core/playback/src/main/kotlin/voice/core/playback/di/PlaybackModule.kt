...
import voice.core.playback.session.DynamicMediaButtons
import voice.core.playback.session.LibrarySessionCallback
import voice.core.playback.session.MediaButtonLayout
...
interface PlaybackModule {
  ...
  fun session(
    ...
    mediaButtonLayout: MediaButtonLayout,
    dynamicMediaButtons: DynamicMediaButtons,
